...
class BaseEnvConfig(object):
    ...
    env.diameter_of_human_blockers = 0.5  # m 人的宽度
    env.h_rx = 1.3  # m, height of RX 设备高度
    env.h_b = 1.7  # m, height of a human blocker
    env.velocity = 18 # 速度
    env.frequence_band = 28  # GHz 带宽
    env.h_d = 120  # m, height of drone-BS 无人机基站高度
    env.alpha_nlos = 113.63 # 非视距传输参数
    env.beta_nlos = 1.16
